...
public class TestAlbum {
	...
	void testCopyConstructor() {
		assertEquals(cpyAl.getArtist(), album.getArtist());
		assertEquals(cpyAl.getName(), album.getName());
		assertEquals(cpyAl.getGenre(), album.getGenre());
		assertEquals(cpyAl.getYear(), album.getYear());
	}
	
	@Test
	void testHashCode() {
		assertEquals(cpyAl.hashCode(), album.hashCode());
	}
