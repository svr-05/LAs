...
public final class User { // No point in having a subclass for user
    ...
    public void writeToFile() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filename))) {
            ...
            // Write song library
            if(musicLibrary.getSongTitles().size() != 0) {
            	for (String songTitle : musicLibrary.getSongTitles()) {
                	System.out.println(musicLibrary.getSongTitles().size());
            ...
            if(musicLibrary.getAlbumList().size() != 0) {
            ...
            // write the playlists
            if(musicLibrary.getPlayList().size() != 0) {
            ...
            // write favorites
            if(musicLibrary.getFavorites().size() != 0) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (type) {
                    ...
                    case "PLAYLIST":
                        ...
                        break;
                    case "FAVORITE":
                    	String[] favparts = parts[2].split(",");
                    	content = favparts[0].trim();
